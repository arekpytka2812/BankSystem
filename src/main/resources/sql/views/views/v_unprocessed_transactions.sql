drop view if exists v_unprocessed_transactions;
create or replace view v_unprocessed_transactions
    as select ord.id order_id,
              ...
              que.balance_change,
              que.active is_active
              from tr_ordered_transaction ord
    left join tr_transaction tr on ord.id_transaction = tr.id
    ...
    left join acc_balance_queue que on ord.id_balance_queue = que.id;